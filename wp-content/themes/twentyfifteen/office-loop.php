...
<figure class="im">
  <a class="cat_img_h" href="<?php echo the_permalink($post) ?>"><img src="<?php echo get_field('основное_фото_дома', $post);?>" /></a>
</figure>
...
?><a class="office_link" href="<?php echo $link; ?>"><button class="btn btn-details">Перейти</button></a><?php
echo '</div>';
