...
<li class="mini-data">
<div class="rayon"><p>Район: </p><strong class="dom_block"><a href="<?php echo '/sdannye-doma-v-odesse/?район='. get_field('район') .''; ?>"><?php echo  get_field('район') ;?></a></strong></div>
<div class="zastr"><p>Застройщик: </p><strong class="prc"><a href="<?php echo '/sdannye-doma-v-odesse/?застройщик='. get_field('застройщик') .''; ?>"><?php echo  get_field('застройщик') ;?></a></strong></div>
</li>
