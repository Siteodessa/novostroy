...
b {
    ...
    margin: 0 7px 0 0px;
} .editka a.post-edit-link { padding: 5px; display:  inline; } button#searchstarter {
    height: 40px;
    width: 80px;
}.search_values {
    display: grid;
    grid-template-columns: 100px 350px 190px 180px 180px 80px;
    grid-gap: 15px;
}.search_values div { margin: 0 10px; } .search_values .sqrt_inp input, .search_values .prc_inp input { width: 70px; margin: 0 10px 0 0; } p.srch_labl { margin: 0; background: #bdbdbde6; color: #444444; font-weight: bold; padding: 4px; } aside { background-color: #6ac2e71f; }
</style><?php
