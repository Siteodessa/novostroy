...
<div class="house_photo_block"> <?php if ($house_address) { ?>  <div class="main_img"><img src="<?= $house_img ?>" ></div> <?php }?> <?php if ($house_gallery) { ?>  <div class="house_gal"><?= $house_gallery ?> </div> <?php }?> </div>
 <?php if ($house_des) {
   ?>  <div class="house_des"><img src=""><strong><?= $house_des ?></strong> </div> <?php }?> </div>
              ...
              <div class="related_block">
               ...
               $metko = get_post_meta($post->ID, 'дом_на_карте', true); if (empty($metko)) {}
                ...
                if (get_field('appar_image', $chi_id)) {
                 print_r(' <div class="one_appartment">');
                ?>  <div class="rel_img">
                  <img src="<?= get_field('appar_image', $chi_id) ?>" ></div>
                  <?php
...
if ($empty_icons > 2){  echo   '<ul class="thin sm xsm">'; } else { echo '<ul class="thin sm">'; };
 ...
 <?php if ($rom) { ?>
   <li><img src="/wp-content/uploads/2018/02/003-building.png" alt="">
   <div class="side_data">    <span>Комнат&nbsp;:</span><strong><?= $sqrt ?> </strong></div>
   </li> <?php }?> <?php if ($section) { ?> <li>
     <img src="/wp-content/uploads/2018/02/002-buildings.png" alt="">
     <div class="side_data">  <span>Секция&nbsp;:</span><strong><?= $section ?></strong></div>
   </span><?php }?>
